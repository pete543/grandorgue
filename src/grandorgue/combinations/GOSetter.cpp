...
static const char *const CRESCENDOS = "crescendos";
static const char *const OVERRIDE_MODE = "override-mode";
static const char *const STEPS = "steps";
static const char *const SEQUENCER = "sequencer";

static const GOMidiObjectContext MIDI_CONTEXT_BANKED_GENERALS(
  BANKED_GENERALS, _("banked-generals"));
static const GOMidiObjectContext MIDI_CONTEXT_CRESCENDOS(
  CRESCENDOS, _("crescendos"));
static const GOMidiObjectContext MIDI_CONTEXT_PITCH(wxT("Pitch"), _("Pitch"));
static const GOMidiObjectContext MIDI_CONTEXT_SEQUENCER(
  wxT("Sequencer"), _("Sequencer"));
static const GOMidiObjectContext MIDI_CONTEXT_SETTER(
  wxT("Setter"), _("Setter"));
static const GOMidiObjectContext MIDI_CONTEXT_TEMPERAMENT(
...
static const GOElementCreator::ButtonDefinitionEntry BUTTON_DEFS[] = {
  {wxT("Prev"),
   GOSetter::ID_SETTER_PREV,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("Next"),
   GOSetter::ID_SETTER_NEXT,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("Set"),
   GOSetter::ID_SETTER_SET,
   true,
   false,
   false,
   &MIDI_CONTEXT_SETTER},
  {wxT("M1"),
   GOSetter::ID_SETTER_M1,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("M10"),
   GOSetter::ID_SETTER_M10,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("M100"),
   GOSetter::ID_SETTER_M100,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("P1"),
   GOSetter::ID_SETTER_P1,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("P10"),
   GOSetter::ID_SETTER_P10,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("P100"),
   GOSetter::ID_SETTER_P100,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("Current"),
   GOSetter::ID_SETTER_CURRENT,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("Home"),
   GOSetter::ID_SETTER_HOME,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("GC"), GOSetter::ID_SETTER_GC, true, true, false, &MIDI_CONTEXT_SETTER},
  {wxT("L0"),
   GOSetter::ID_SETTER_L0,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("L1"),
   GOSetter::ID_SETTER_L1,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("L2"),
   GOSetter::ID_SETTER_L2,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("L3"),
   GOSetter::ID_SETTER_L3,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("L4"),
   GOSetter::ID_SETTER_L4,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("L5"),
   GOSetter::ID_SETTER_L5,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("L6"),
   GOSetter::ID_SETTER_L6,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("L7"),
   GOSetter::ID_SETTER_L7,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("L8"),
   GOSetter::ID_SETTER_L8,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("L9"),
   GOSetter::ID_SETTER_L9,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  ...
  {wxT("Regular"),
   ...
   &MIDI_CONTEXT_SETTER},
  {wxT("Scope"),
   GOSetter::ID_SETTER_SCOPE,
   true,
   true,
   false,
   &MIDI_CONTEXT_SETTER},
  {wxT("Scoped"),
   GOSetter::ID_SETTER_SCOPED,
   true,
   true,
   false,
   &MIDI_CONTEXT_SETTER},
  {wxT("Full"),
   GOSetter::ID_SETTER_FULL,
   true,
   false,
   false,
   &MIDI_CONTEXT_SETTER},
  {wxT("Insert"),
   GOSetter::ID_SETTER_INSERT,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {wxT("Delete"),
   GOSetter::ID_SETTER_DELETE,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {GOSetter::KEY_REFRESH_FILES,
   GOSetter::ID_SETTER_REFRESH_FILES,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {GOSetter::KEY_PREV_FILE,
   GOSetter::ID_SETTER_PREV_FILE,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {GOSetter::KEY_NEXT_FILE,
   GOSetter::ID_SETTER_NEXT_FILE,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {GOSetter::KEY_LOAD_FILE,
   GOSetter::ID_SETTER_LOAD_FILE,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {GOSetter::KEY_SAVE_FILE,
   GOSetter::ID_SETTER_SAVE_FILE,
   true,
   true,
   false,
   &MIDI_CONTEXT_SEQUENCER},
  {GOSetter::KEY_SAVE_SETTINGS,
   GOSetter::ID_SETTER_SAVE_SETTINGS,
   true,
   true,
   false,
   &MIDI_CONTEXT_SETTER},
  ...
  {wxT("General01"),
   GOSetter::ID_SETTER_GENERAL00,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General02"),
   GOSetter::ID_SETTER_GENERAL01,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General03"),
   GOSetter::ID_SETTER_GENERAL02,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General04"),
   GOSetter::ID_SETTER_GENERAL03,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General05"),
   GOSetter::ID_SETTER_GENERAL04,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General06"),
   GOSetter::ID_SETTER_GENERAL05,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General07"),
   GOSetter::ID_SETTER_GENERAL06,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General08"),
   GOSetter::ID_SETTER_GENERAL07,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General09"),
   GOSetter::ID_SETTER_GENERAL08,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General10"),
   GOSetter::ID_SETTER_GENERAL09,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General11"),
   GOSetter::ID_SETTER_GENERAL10,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General12"),
   GOSetter::ID_SETTER_GENERAL11,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General13"),
   GOSetter::ID_SETTER_GENERAL12,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General14"),
   GOSetter::ID_SETTER_GENERAL13,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General15"),
   GOSetter::ID_SETTER_GENERAL14,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General16"),
   GOSetter::ID_SETTER_GENERAL15,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General17"),
   GOSetter::ID_SETTER_GENERAL16,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General18"),
   GOSetter::ID_SETTER_GENERAL17,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General19"),
   GOSetter::ID_SETTER_GENERAL18,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General20"),
   GOSetter::ID_SETTER_GENERAL19,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General21"),
   GOSetter::ID_SETTER_GENERAL20,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General22"),
   GOSetter::ID_SETTER_GENERAL21,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General23"),
   GOSetter::ID_SETTER_GENERAL22,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General24"),
   GOSetter::ID_SETTER_GENERAL23,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General25"),
   GOSetter::ID_SETTER_GENERAL24,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General26"),
   GOSetter::ID_SETTER_GENERAL25,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General27"),
   GOSetter::ID_SETTER_GENERAL26,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General28"),
   GOSetter::ID_SETTER_GENERAL27,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General29"),
   GOSetter::ID_SETTER_GENERAL28,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General30"),
   GOSetter::ID_SETTER_GENERAL29,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General31"),
   GOSetter::ID_SETTER_GENERAL30,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General32"),
   GOSetter::ID_SETTER_GENERAL31,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General33"),
   GOSetter::ID_SETTER_GENERAL32,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General34"),
   GOSetter::ID_SETTER_GENERAL33,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General35"),
   GOSetter::ID_SETTER_GENERAL34,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General36"),
   GOSetter::ID_SETTER_GENERAL35,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General37"),
   GOSetter::ID_SETTER_GENERAL36,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General38"),
   GOSetter::ID_SETTER_GENERAL37,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General39"),
   GOSetter::ID_SETTER_GENERAL38,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General40"),
   GOSetter::ID_SETTER_GENERAL39,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General41"),
   GOSetter::ID_SETTER_GENERAL40,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General42"),
   GOSetter::ID_SETTER_GENERAL41,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General43"),
   GOSetter::ID_SETTER_GENERAL42,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General44"),
   GOSetter::ID_SETTER_GENERAL43,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General45"),
   GOSetter::ID_SETTER_GENERAL44,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General46"),
   GOSetter::ID_SETTER_GENERAL45,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General47"),
   GOSetter::ID_SETTER_GENERAL46,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General48"),
   GOSetter::ID_SETTER_GENERAL47,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General49"),
   GOSetter::ID_SETTER_GENERAL48,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  {wxT("General50"),
   GOSetter::ID_SETTER_GENERAL49,
   true,
   true,
   true,
   &MIDI_CONTEXT_BANKED_GENERALS},
  ...
  {wxT("GeneralPrev"),
   GOSetter::ID_SETTER_GENERAL_PREV,
   true,
   true,
   false,
   &MIDI_CONTEXT_BANKED_GENERALS,
  ...
  {wxT("CrescendoPrev"),
   ...
   true,
   false,
   &MIDI_CONTEXT_CRESCENDOS},
  {wxT("CrescendoCurrent"),
   GOSetter::ID_SETTER_CRESCENDO_CURRENT,
   true,
   true,
   false,
   &MIDI_CONTEXT_CRESCENDOS},
  {wxT("CrescendoNext"),
   GOSetter::ID_SETTER_CRESCENDO_NEXT,
   true,
   true,
   false,
   &MIDI_CONTEXT_CRESCENDOS},
  {wxT("CrescendoA"),
   GOSetter::ID_SETTER_CRESCENDO_A,
   true,
   true,
   false,
   &MIDI_CONTEXT_CRESCENDOS},
  {wxT("CrescendoB"),
   GOSetter::ID_SETTER_CRESCENDO_B,
   true,
   true,
   false,
   &MIDI_CONTEXT_CRESCENDOS},
  {wxT("CrescendoC"),
   GOSetter::ID_SETTER_CRESCENDO_C,
   true,
   true,
   false,
   &MIDI_CONTEXT_CRESCENDOS},
  {wxT("CrescendoD"),
   GOSetter::ID_SETTER_CRESCENDO_D,
   true,
   true,
   false,
   &MIDI_CONTEXT_CRESCENDOS},
  {wxT("CrescendoOverride"),
   GOSetter::ID_SETTER_CRESCENDO_OVERRIDE,
   true,
   false,
   false,
   &MIDI_CONTEXT_CRESCENDOS},
  ...
  {wxT("TemperamentPrev"),
   GOSetter::ID_SETTER_TEMPERAMENT_PREV,
   true,
   true,
   false,
   &MIDI_CONTEXT_TEMPERAMENT},
  {wxT("TemperamentNext"),
   GOSetter::ID_SETTER_TEMPERAMENT_NEXT,
   true,
   true,
   false,
   &MIDI_CONTEXT_TEMPERAMENT},
  {wxT("PitchM1"),
   GOSetter::ID_SETTER_PITCH_M1,
   true,
   true,
   false,
   &MIDI_CONTEXT_PITCH},
  {wxT("PitchM10"),
   GOSetter::ID_SETTER_PITCH_M10,
   true,
   true,
   false,
   &MIDI_CONTEXT_PITCH},
  {wxT("PitchM100"),
   GOSetter::ID_SETTER_PITCH_M100,
   true,
   true,
   false,
   &MIDI_CONTEXT_PITCH},
  {wxT("PitchP1"),
   GOSetter::ID_SETTER_PITCH_P1,
   true,
   true,
   false,
   &MIDI_CONTEXT_PITCH},
  {wxT("PitchP10"),
   GOSetter::ID_SETTER_PITCH_P10,
   true,
   true,
   false,
   &MIDI_CONTEXT_PITCH},
  {wxT("PitchP100"),
   GOSetter::ID_SETTER_PITCH_P100,
   true,
   true,
   false,
   &MIDI_CONTEXT_PITCH},
  {wxT("TransposeDown"),
   GOSetter::ID_SETTER_TRANSPOSE_DOWN,
   true,
   true,
   false,
   &MIDI_CONTEXT_TRANSPOSE},
  {wxT("TransposeUp"),
   GOSetter::ID_SETTER_TRANSPOSE_UP,
   true,
   true,
   false,
   &MIDI_CONTEXT_TRANSPOSE},
  ...
  {wxT("PanicButton"),
   GOSetter::ID_SETTER_AUDIO_PANIC,
   true,
   true,
   true,
   &MIDI_CONTEXT_SETTER},
  {wxT("ExitGO"),
   GOSetter::ID_SETTER_FILE_EXIT,
   true,
   true,
   true,
   &MIDI_CONTEXT_SETTER},
...
const GOSetter::ButtonDefinitionEntry *const GOSetter::P_BUTTON_DEFS
  = BUTTON_DEFS;
...
GOSetter::GOSetter(GOOrganController *organController)
  : m_OrganController(organController),
    ...
    m_general(0),
    m_crescendo(0),
    m_CurrFileDisplay(*organController, &MIDI_CONTEXT_SEQUENCER),
    m_PosDisplay(*organController, &MIDI_CONTEXT_SEQUENCER),
    m_BankDisplay(*organController, &MIDI_CONTEXT_BANKED_GENERALS),
    m_CrescendoDisplay(*organController, &MIDI_CONTEXT_CRESCENDOS),
    m_TransposeDisplay(*organController, &MIDI_CONTEXT_TRANSPOSE),
    m_NameDisplay(*organController, &MIDI_CONTEXT_SETTER),
...
static wxString general_yaml_key(unsigned i) {
  return wxString::Format(WX_U, i);
}
...
static wxString crescendo_step_yaml_key(unsigned i) {
  return wxString::Format(WX_U, i + 1);
}

static wxString sequencer_cmb_yaml_key(unsigned i) {
